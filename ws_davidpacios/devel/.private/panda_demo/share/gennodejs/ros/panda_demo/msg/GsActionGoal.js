...
class GsActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GsGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GsActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = GsGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new GsGoal()
    }
