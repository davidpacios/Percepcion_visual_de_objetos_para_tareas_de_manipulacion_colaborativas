...
"""autogenerated by genpy from panda_demo/GsActionResult.msg. Do not edit."""
import codecs
import sys
...
class GsActionResult(genpy.Message):
  _md5sum = "7465fa8c99a14456781a463c0e1bd37b"
  _type = "panda_demo/GsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','panda_demo/GsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = panda_demo.msg.GsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = panda_demo.msg.GsResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.distance,) = _get_struct_f().unpack(str[start:end])
      return self
