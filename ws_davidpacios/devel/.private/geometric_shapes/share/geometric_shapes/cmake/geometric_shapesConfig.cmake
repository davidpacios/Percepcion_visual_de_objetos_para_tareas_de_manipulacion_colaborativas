...
if(NOT "/home/frankaros/ws_davidpacios/src/geometric_shapes/include;/usr/include/eigen3;/opt/ros/noetic/include;/usr/include " STREQUAL " ")
  set(geometric_shapes_INCLUDE_DIRS "")
  set(_include_dirs "/home/frankaros/ws_davidpacios/src/geometric_shapes/include;/usr/include/eigen3;/opt/ros/noetic/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/frankaros/ws_davidpacios/src/geometric_shapes/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/frankaros/ws_davidpacios/devel/.private/geometric_shapes/lib;/home/frankaros/ws_davidpacios/devel/lib;/home/frankaros/ros_own_gripper/devel/lib;/home/frankaros/ws_moveit/devel/lib;/opt/ros/noetic/lib)
