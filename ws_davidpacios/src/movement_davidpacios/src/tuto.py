...
class MoveGroupPythonInterfaceTutorial(object):
    ...
    def add_box(self, timeout=4):
        ...
        scene.add_box(box_name, box_pose, size=(0.030, 0.032, 0.105))
    ...
    def add_table(self, timeout=4):
        ...
        box_pose.pose.orientation.z = 0.0
        box_pose.pose.orientation.w = 1.0
        scene.add_box("table", box_pose, size=(1.0, 1.0, 0.06))
    ...
    def closedGripper(self, posture):
        ...
        posture.points.append(trajectory_msgs.msg.JointTrajectoryPoint())
        posture.points[0].positions = [0.0145,0.0145]
        posture.points[0].time_from_start = rospy.Duration.from_sec(0.5)
        return
...
def main():
    try:
        print("")
        print("----------------------------------------------------------")
        print("Starting the pick and place tutorial")
        print("----------------------------------------------------------")
        ...
        input(
            "============ Press `Enter` to get eef pose ..."
        )
        print(tutorial.get_current_pose())

        input(
            "============ Press `Enter` to go to default joint state ..."
        )
        tutorial.go_to_default_joint_state()
        ...
        wpose.position.z = 0.1756
        wpose.orientation.x = 0.3797
        wpose.orientation.y = 0.9239
        wpose.orientation.z = 0.0054
        wpose.orientation.w = 0.0482
